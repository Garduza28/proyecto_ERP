@extends('layouts.app', ['class' => 'register-page', 'page' => __(''), 'contentClass' => 'register-page'])
        ...
        <div class="col-md-7 mr-auto">
            <div class="card card-register card-white">
                <div class="card-header">
                    <img class="card-img" src="{{ asset('black') }}/img/card-primary1.png" alt="Card image">
                    <h4 class="card-title" style="color: black;">{{ __('Registrarse') }}</h4>
                </div>
